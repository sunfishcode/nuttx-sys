...
pub const PIPE_BUF: c_int = _POSIX_PIPE_BUF;
...
pub const S_IFBLK: c_int = 6 << 12;
pub const S_IFCHR: c_int = 2 << 12;
pub const S_IFDIR: c_int = 4 << 12;
pub const S_IFIFO: c_int = 1 << 12;
pub const S_IFLNK: c_int = 10 << 12;
pub const S_IFMTD: c_int = 9 << 12;
pub const S_IFMT: c_int = 15 << 12;
pub const S_IFREG: c_int = 8 << 12;
pub const S_IFSOCK: c_int = 12 << 12;
pub const S_IRGRP: c_int = 1 << 5;
pub const S_IROTH: c_int = 1 << 2;
pub const S_IRUSR: c_int = 1 << 8;
pub const S_IRWXG: c_int = 7 << 3;
pub const S_IRWXO: c_int = 7 << 0;
pub const S_IRWXU: c_int = 7 << 6;
pub const S_ISGID: c_int = 1 << 10;
pub const S_ISUID: c_int = 1 << 11;
pub const S_ISVTX: c_int = 1 << 9;
pub const S_IWGRP: c_int = 1 << 4;
pub const S_IWOTH: c_int = 1 << 1;
pub const S_IWUSR: c_int = 1 << 7;
pub const S_IXGRP: c_int = 1 << 3;
pub const S_IXOTH: c_int = 1 << 0;
pub const S_IXUSR: c_int = 1 << 6;
